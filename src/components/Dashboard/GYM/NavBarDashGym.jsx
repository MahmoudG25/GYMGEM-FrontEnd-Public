...
const NavBarDashGym = () => {
  ...
  const links = [
    { to: "/", label: "Home" },
    { to: "/gym/Gymprofile", label: "Profile" },
    { to: "/gym", label: "Dashboard" },
    { to: "/gym/GymMember", label: "Member" },
    { to: "/gym/GymSessions", label: "Sessions" },
    { to: "/gym/GymClasses", label: "Classes" },
  ];
